...
const TaskDetails = () => {
    ...
    const handleAddComment = async () => {
        ...
        try {
            ...
            // Add newly created comment immediately
            if (data?.comment) {
                setComments((prev) => [
                    ...prev,
                    data.comment,
                ...
                // If backend doesn't return comment,
                ...
                <div className="p-5 rounded-md border border-gray-300 dark:border-zinc-800 flex flex-col lg:h-[80vh]">
                    ...
                    <div className="flex flex-col sm:flex-row items-start sm:items-end gap-3">
                        ...
                        <button
                            ...
                            className="bg-gradient-to-l from-blue-500 to-blue-600 hover:opacity-90 disabled:opacity-50 transition-colors text-white text-sm px-5 py-2 rounded"
                        >
                            {isPosting
                                ? "Posting..."
                                : "Post"}
